...
const Fored = () => {
  ...
  return (
    <div>
      ...
      {/* Add the heading outside the content box */}
      <div className="fored-heading-container">
        <h1 className="fored-heading">FORED</h1>
      </div>

      <div className="fored-creative-container">
        <div className="fored-content-box">
          <img
            src={ForedImg}
            alt="Creative"
            className="fored-creative-image"
          />
          <div className="fored-text-content">
            <h1>FORED</h1>
            <p>
